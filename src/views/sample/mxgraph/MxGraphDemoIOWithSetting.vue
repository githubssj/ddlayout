    ...
    <div class="nsneo-mxgraph-content">
      ...
      <div class="nsneo-mxgraph-right">
        <Form :model="mainForm" size="small">
          <FormItem label="输入框">
            <Input v-model="mainForm.input" placeholder="Enter something..."></Input>
          </FormItem>
          <FormItem label="选择框">
          ...
          <FormItem label="日期">
            <Row>
              <Col span="24">
              <DatePicker type="date" placeholder="Select date" v-model="mainForm.date" style="width:100%"></DatePicker>
              </Col>
            </Row>
          ...
          <FormItem label="时间">  
            <Row>
              <Col span="24">
              <TimePicker type="time" placeholder="Select time" v-model="mainForm.time" style="width:100%"></TimePicker>
              </Col>
            </Row>
          ...
          <FormItem label="复选">
            ...
            <Row>
              <Col span="24">
            <CheckboxGroup v-model="mainForm.checkbox">
          ...
          <FormItem label="开关">
            <i-switch v-model="mainForm.switch" size="large">
          ...
          <FormItem label="Slider">
            ...
            <Row>
              <Col span="24">
              <Slider v-model="mainForm.slider" range></Slider>
              </Col>
            </Row>
