  ...
  <div class="nsneo-inner-root">
    <div class="nsneo-inner-header">
      <Breadcrumb class="nsneo-module-breadcrumb">
        ...
        <BreadcrumbItem>
          <Icon type="logo-buffer"></Icon>输出格式化编辑
        </BreadcrumbItem>
      </Breadcrumb>
    ...
    <div class="nsneo-inner-container">
      ...
      <Form :model="mainForm" :label-width="120" style="width:900px">
        <FormItem label="名称">
          <Input v-model="mainForm.name" placeholder="请输入输出格式化工具名称"></Input>
        </FormItem>
        
        <FormItem label="类型">
          <Select v-model="mainForm.type">
        ...
        <FormItem label="服务包">
          <Upload multiple type="drag" action="//jsonplaceholder.typicode.com/posts/">
            <div style="padding: 20px 0">
              ...
              <p>点击此处上传以java -jar 方式打包的格式化规则器</p>
            </div>
          </Upload>
        </FormItem>
